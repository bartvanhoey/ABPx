...
## C# snippets [(source code)](https://github.com/bartvanhoey/ABPx/blob/master/snippets/csharp.json)
     ...
     xGetContextServiceProviderGetRequiredService  | Inserts var service = context.ServiceProvider.GetRequiredService<IUserService>();                
     ...
     xImpISoftDelete                               | Implements ISoftDelete interface                                                                 
     ...
     xIDataFilterCtorParam                         | Inserts a IDataFilter parameter in the constructor                                               
     xUsingDataFilterDisable                       | Inserts a using DataFilter.Disable statement                                                     
     ...
     xClaimsIdentity                               | Inserts statement ClaimsIdentity$1 identity = context.ClaimsPrincipal.Identities.FirstOrDefault()
