...
## C# snippets [(source code)](https://github.com/bartvanhoey/ABPx/blob/master/snippets/csharp.json)
     ...
     Inserts a completed ICrudAppService interface with CreateUpdateDto combined | Inserts a completed ICrudAppService interface with CreateUpdateDto combined              
